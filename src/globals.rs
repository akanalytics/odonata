...
mod tests {
    ...
    fn sizes() {
        ...
        assert_eq!(size_of::<SimpleScorer>(), 4144, "SimpleScorer");
        assert_eq!(size_of::<Pvs>(), 8, "Pvs");
        assert_eq!(size_of::<Extensions>(), 32, "Extensions");
        assert_eq!(size_of::<Lmr>(), 36, "Lmr");
        assert_eq!(size_of::<MoveTimeEstimator>(), 336, "MoveTimeEstimator");
        ...
        assert_eq!(size_of::<Aspiration>(), 16, "Aspiration");
        assert_eq!(size_of::<Counts>(), 16, "Counts");
        assert_eq!(size_of::<SearchStats>(), 800, "SearchStats");
