...
impl<'a> Analysis<'a> {
    ...
    pub fn knight_attacks(&self, c: Color) -> Bitboard {
        ...
        match knights.popcount() {
            ...
            2 => PreCalc::default().knight_attacks(knights.first_square()) | PreCalc::default().knight_attacks(knights.last_square()),
            _ => {
...
mod tests {
    ...
    fn benchmark_king_attacks() {
        ...
        for _ in 0..100 {
            ...
            prof.stop();
            assert_eq!(ka, bbd.within_chebyshev_distance_inclusive(Square::E1, 1) - Bitboard::E1);
        }
        assert_eq!(
