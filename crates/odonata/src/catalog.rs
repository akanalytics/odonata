...
"#;
    ...
    pub fn stalemates() -> [Board; 2] {
        [
            Board::parse_fen("k7/8/1Q6/8/8/8/8/7K b - - 0 1").unwrap(),
            Board::parse_fen("K7/7r/8/8/8/8/8/1r5k w - - 0 1").unwrap(),
        ]
    }
...
"#;
    ...
    pub fn chess960(id: u32) -> Position {
        ...
        pos.tags_mut().id = Some(format!("Chess960(SP{id})"));
        pos
    }
}
