use crate::{boards::Board, domain::TreeCrit};
// use crate::Bitboard;
// use crate::boards::Board;
use crate::{domain::BoundType, piece::Ply};
// use crate::eval::weight::Weight;
// use crate::search::node::Node;
use crate::{eval::score::Score, mv::Move, search::algo::Algo, variation::Variation};
...
use crate::{
    domain::{search_results::WithExplanation, SearchTree, TreeNode},
    piece::MoveType,
};
...
mod tests {
    ...
    fn test_search_explainer_tree() {
        ...
        eng.algo.explainer.add_variation_to_explain(v1);
        eng.algo.run_search();
