...
use crate::{infra::utils::Formatting, other::Phase};
    ...
    T: Copy + Num + fmt::Display + Into<f64>,
{
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(
            f,
            "({}, {}, {})",
            Formatting::decimal(2, self.s()),
            Formatting::decimal(2, self.m()),
            Formatting::decimal(2, self.e())
        )
    }
}
