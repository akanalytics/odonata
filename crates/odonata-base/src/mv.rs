use crate::{
    ...
    boards::BoardCalcs,
    globals::constants::*,
    infra::utils::StringUtils,
    piece::{Color, Piece},
    prelude::Board,
    PreCalc, FlipVertical,
};
...
mod tests {
    use super::*;
    use crate::{catalog::Catalog, infra::profiler::PerfProfiler, other::Perft};
    use std::{hint::black_box, iter::once};
    use test_log::test;
